...
export const SupportPage = () => {
  ...
  const [message, setMessage] = useState(() => {
    return sessionStorage.getItem("supportMessage") ?? "";
  });

  const phone = import.meta.env.VITE_BUSINESS_PHONE_NUMBER as
    | string
    | undefined;
      ...
      <Content title="Got a question?">
        ...
        <div className="mt-4 flex justify-center">
          <button
            ...
            onClick={handleSend}
            className="relative inline-flex items-center gap-2 rounded-xl px-6 py-2.5 text-sm font-semibold text-white transition-all bg-[#25D366] hover:bg-[#1ebe57] disabled:pointer-events-none disabled:opacity-60"
            style={{
              backgroundImage:
                "radial-gradient(ellipse 100% 100% at 50% 100%, rgba(18,140,126,0.50) 0%, transparent 65%)",
            }}
          >
