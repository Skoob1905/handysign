...
export const Footer = () => {
  ...
  return (
    <footer
      className="border-t border-[#CCFBF1] py-3"
    ...
    >
      ...
      <div className="mx-auto mt-3 max-w-6xl border-t border-[#CCFBF1] px-4 pt-3 text-center text-[11px] text-[var(--muted-foreground)]">
